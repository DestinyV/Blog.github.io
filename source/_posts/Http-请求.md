...
# HTTP 消息结构
 ...
 ![请求报文](Http-请求/2012072810301161.png)
 ## 服务器响应消息
   HTTP响应也由四个部分组成，分别是：状态行、消息报头、空行和响应正文。 
 ![HTTP响应](Http-请求/574e9258d109b3dea515b2e0c6bf6c81810a4c8b.jpg)
...
.apk	application/vnd.android.package-archive	.xap	application/x-silverligh
```